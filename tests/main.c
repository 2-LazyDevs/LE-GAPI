...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE hPrev, LPSTR lpCmdLine, int nShowCmd) {
    ...
    while (le_pe(ctx)) {
        ...
        le_drl(ctx, 50, 50, 300, 200, le_mc(255,255,255,255));                 
        le_frect(ctx, 400, 100, 120, 80, le_mc(255,0,0,255));                  
        le_dp(ctx, 320, 240, le_mc(0,255,0,255));                              
        le_drcircle(ctx, 150, 350, 50, le_mc(255,255,0,255));                  
        le_fcircle(ctx, 500, 300, 75, le_mc(0,0,255,255));
        le_frect(ctx, 100, 100, 100, 100, le_mc(234, 233, 232, 231));                     
